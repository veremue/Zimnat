            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h4 class="page-header"> Zimnat | Insurance Quote </h4>
                ...
                <div class = "panel-body">
                 <?php
						...
						{
						?>
						<form class="form-header" action="quote.php" method="POST" id="#" autocomplete="off">
                   ...
                   <div class = "col-sm-4">
					...
					<option value="Country Not Specified" selected >---- Choose Country of Residence ----</option>
					...
					<button name = "nextpage" type = "submit" class = "btn btn-success btn-block"> Continue <i class = "fa fa-arrow-circle-right"></i></button>
					</div>
					...
					<input type="hidden" name="homephone" value="<?php  echo $homephone ?>" class = "form-control"  required/>
						<button name = "nextpage" type = "submit" class = "btn btn-success btn-block"> Get Quote <i class = "fa fa-check-circle-right"></i></button>
						</div>
							<p class="privacy text-center"> <a href="#"></a>.</p>
						</form>
						<?php
